...
class PoseResNet(nn.Module):
    ...
    def init_weights(self, num_layers, pretrained=True):
        if pretrained:
            ...
            self.load_state_dict(torch.load('/home/konglingbin/project/dota/CenterNet/models/seresnet50-60a8950a85b2b.pkl'), strict=False)
        else:
...
resnet_spec = {18: (SEBasicBlock, [2, 2, 2, 2]),
